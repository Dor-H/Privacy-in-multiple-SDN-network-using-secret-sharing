...
//	 */
//	public boolean addEdge(String from, String to, int capacity,short sourcePort,short destPort) throws IllegalArgumentException 
//	{
//		System.out.println("in addEdge,       m_vertices: " + m_vertices.toString());
//		if (m_vertices.containsKey(from) == false)
//		{
//			throw new IllegalArgumentException("from is not in graph " + from);
//		}
//		if (m_vertices.containsKey(to) == false) {
//			throw new IllegalArgumentException("to is not in graph");
//		}
//		Edge e = new Edge(m_vertices.get(from), m_vertices.get(to), capacity,sourcePort.getShortPortNumber(),destPort.getShortPortNumber());
//		return addEdge(e);
//	}
