...
public class Vertex implements Comparable<Vertex> 
{
	...
	private boolean myVertex;
	
	private String sdnVertex;
	...
	public String getRules() {
		...
		{
			rules += "flowId: " + r.flowId + " from: " + r.srcName + " to: " + r.destName + "\n";
		}
		return rules;
	}

	public void addRule(String srcName,String destName,int flowId) {
		Rule r = new Rule(srcName,destName,flowId);
		this.rules.add(r);
	}
	...
	public boolean isMyVertex() {
		return myVertex;
	}

	public void setMyVertex(boolean myVertex) {
	...
	public String getSdnVertex() {
		return sdnVertex;
	}

	public void setSdnVertex(String sdnVertex) {
		this.sdnVertex = sdnVertex;
	}
	...
	private class Rule
	{
		...
		public Rule(String srcName,String destName,int flowId)
		{
